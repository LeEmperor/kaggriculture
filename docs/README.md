...
| [`ocaml_migration_decisions.md`](ocaml_migration_decisions.md) | Adopted decision record | OCaml as the primary development language. Steps 1–10 have landed: the trusted native simulator, native DSL evaluation, same-workload Phase 5 benchmark, and fixed worker pool are complete. Phase 6 strategy work is next. |
